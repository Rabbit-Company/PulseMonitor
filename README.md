...
headers = [
	...
	{ "User-Agent" = "Mozilla/5.0 (compatible; PulseMonitor/3.7.0; +https://github.com/Rabbit-Company/PulseMonitor)" },
	{ "X-Latency" = "{latency}" },
]
...
```bash
# Download the binary
wget https://github.com/Rabbit-Company/PulseMonitor/releases/download/v3.7.0/pulsemonitor
